...
public class USBCameraActivity3 extends AppCompatActivity implements CameraDialog.CameraDialogParent {

    private static final String TAG = USBCameraActivity3.class.getSimpleName();
    ...
    private USBCameraManager.OnMyDevConnectListener listener = new USBCameraManager.OnMyDevConnectListener() {
        ...
        public void onAttachDev(UsbDevice device) {
            ...
            if (!isRequest) {
                isRequest = true;
                if (mUSBManager != null) {
                    mUSBManager.requestPermission(ConstantPool.Camera_3);
                }
            }
        }
